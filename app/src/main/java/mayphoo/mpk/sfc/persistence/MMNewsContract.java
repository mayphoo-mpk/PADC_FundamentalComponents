...
public class MMNewsContract {
    ...
    public static final String PATH_IMAGE_IN_NEWS = "image";
    ...
    public static class ImageInNewsEntry implements BaseColumns {

        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_IMAGE_IN_NEWS).build();

        public static final String DIR_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_IMAGE_IN_NEWS;

        public static final String ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_IMAGE_IN_NEWS;

        public static final String TABLE_NAME = PATH_IMAGE_IN_NEWS;

        public static final String COLUMN_IMAGE_URL = "image_url";
        public static final String COLUMN_NEWS_ID = "news_id";

        public static Uri buildImageInNewsUri(long id) {
            return ContentUris.withAppendedId(CONTENT_URI, id);
        }
    }
    ...
    public static class PublicationEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_PUBLICATIONS).build();
    ...
    public static class FavoriteActionEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_FAVORITE_ACTIONS).build();
    ...
    public static class CommentActionEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_COMMENT_ACTIONS).build();
        ...
        public static Uri buildCommentActionUri(long id) {
            return ContentUris.withAppendedId(CONTENT_URI, id);
        }
    }
    ...
    public static class SentToActionEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_SENT_TO_ACTIONS).build();
        ...
        public static final String COLUMN_SENT_TO_ID = "sent_id";
        public static final String COLUMN_SENT_DATE = "sent_date";
        public static final String COLUMN_NEWS_ID = "news_id";
        public static final String COLUMN_SENDER_ID = "sender_id";
        public static final String COLUMN_RECEIVER_ID = "receiver_id";

        public static Uri buildSentToActionUri(long id) {
            return ContentUris.withAppendedId(CONTENT_URI, id);
        }
    }
    ...
    public static class ActedUserEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_ACTED_USERS).build();
        ...
        public static Uri buildActedUserUri(long id) {
            return ContentUris.withAppendedId(CONTENT_URI, id);
        }
