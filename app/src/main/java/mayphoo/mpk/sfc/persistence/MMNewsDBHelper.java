...
public class MMNewsDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_IMAGE_IN_NEWS = "CREATE TABLE " + MMNewsContract.ImageInNewsEntry.TABLE_NAME + " (" +
    ...
    private static final String SQL_CREATE_COMMENT_ACTION = "CREATE TABLE " + MMNewsContract.CommentActionEntry.TABLE_NAME + " (" +
    ...
    private static final String SQL_CREATE_SENT_TO_ACTION = "CREATE TABLE " + MMNewsContract.SentToActionEntry.TABLE_NAME + " (" +
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(SQL_CREATE_ACTED_USER);      //leak table
        db.execSQL(SQL_CREATE_PUBLICATION);     //leak table
        db.execSQL(SQL_CREATE_NEWS);
        db.execSQL(SQL_CREATE_IMAGE_IN_NEWS);

        db.execSQL(SQL_CREATE_FAVORITE_ACTION);
        db.execSQL(SQL_CREATE_COMMENT_ACTION);
        db.execSQL(SQL_CREATE_SENT_TO_ACTION);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int i, int i1) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + MMNewsContract.ImageInNewsEntry.TABLE_NAME);
